  ...
  return (
    <div id={id} style={S.container}>
      ...
      <div style={S.section}>
        ...
        >
          ...
          <li style={{ marginBottom: "6px" }}>
            ...
            <strong>14/01/2025</strong> tại Ninh Kiều - Thuế cơ sở 1 thành phố
            Cần Thơ.
          </li>
        ...
        <div style={{ fontSize: "12pt", lineHeight: 1.6 }}>
          ...
          >
            <li style={{ marginBottom: "8px" }}>
              ...
              thu hồi, bán, chuyển nhượng, sang tên và cấn trừ nghĩa vụ nợ đối
              với tài sản nêu tại Điều 1{" "}
              <strong>
                chỉ trong trường hợp Bên ủy quyền vi phạm nghĩa vụ thanh toán
            ...
            <li style={{ marginBottom: "8px" }}>
              ...
              <strong>
                trong thời gian Bên ủy quyền chưa hoàn thành đầy đủ nghĩa vụ tài
                chính
              </strong>{" "}
              theo Hợp đồng cầm cố.
            </li>
            ...
            <li>
              ...
              nhiệm thông báo cho Bên ủy quyền trong thời hạn hợp lý theo quy
              định pháp luật, trừ trường hợp pháp luật có quy định khác.
            </li>
          </ol>
        </div>
      </div>
      ...
      <div style={S.section}>
        ...
        <p style={{ marginBottom: "8px" }}>
          Bên ủy quyền xác nhận rằng việc ký kết Giấy ủy quyền này là{" "}
          <strong>hoàn toàn tự nguyện</strong>, không bị ép buộc, đe dọa, lừa
          dối hoặc nhầm lẫn.
        </p>
        <p style={{ marginBottom: "8px" }}>
          Bên ủy quyền xác nhận đã được Bên được ủy quyền{" "}
          <strong>giải thích đầy đủ, rõ ràng và dễ hiểu</strong> về nội dung,
          phạm vi, quyền, nghĩa vụ và hậu quả pháp lý phát sinh từ việc ký Giấy
          ủy quyền này, bao gồm cả quyền xử lý tài sản cầm cố trong trường hợp
          vi phạm nghĩa vụ.
        </p>
        <p style={{ marginBottom: "60px" }}>
          Bên ủy quyền hiểu rõ và đồng ý rằng việc ủy quyền xử lý tài sản cầm cố
          là nhằm bảo đảm thực hiện nghĩa vụ theo Hợp đồng cầm cố đã ký, và
        ...
        >
          <div style={{ ...S.center, width: "45%" }}>
            <p style={{ ...S.bold }}>BÊN ĐƯỢC ỦY QUYỀN</p>
