    ...
    <div id={id} style={S.container}>
      ...
      <div style={S.section}>
        ...
        <div style={{ fontSize: "12pt", marginBottom: "16px" }}>
          ...
          >
            <li style={{ marginBottom: "8px" }}>Căn cứ Bộ luật Dân sự 2015;</li>
            ...
            <li>
              Căn cứ nhu cầu sử dụng thực tế và sự tự nguyện thỏa thuận của các
              bên.
            </li>
          </ul>
        </div>
      ...
      <div style={S.section}>
        ...
        <div
          style={{ fontSize: "12pt", marginBottom: "16px", lineHeight: 1.6 }}
        >
          <ul
            style={{
              paddingLeft: "40px",
          ...
          >
            ...
            <li style={{ marginBottom: "6px" }}>
              <strong>CCCD:</strong> {data.CCCD}; <strong>Ngày cấp:</strong>{" "}
              {data.NGAY_CAP}; <strong>Nơi cấp:</strong> {data.NOI_CAP}.
            </li>
      ...
      <div style={S.section}>
        ...
        <div style={{ fontSize: "12pt", lineHeight: 1.6 }}>
          <ol
            style={{ paddingLeft: "40px", margin: 0, listStyleType: "decimal" }}
          >
            {/* 1 */}
            ...
            <li style={{ marginBottom: "10px" }}>
              ...
              đúng mô tả và tình trạng hoạt động bình thường khi ký hợp đồng
              này.
            </li>
            ...
            <li>
              ...
              >
                <li style={{ marginBottom: "6px" }}>
                  Bên B xác nhận rằng tài sản này đang thuộc quyền quản lý hợp
                  pháp của Bên A theo Hợp đồng cầm cố.
                </li>
                <li style={{ marginBottom: "6px" }}>
                  Bên B có nhu cầu thực tế sử dụng tài sản và chủ động đề nghị
                  thuê.
                </li>
                <li>
                  Giao dịch thuê này là độc lập, không phải là điều kiện bắt
                  buộc của bất kỳ văn bản pháp lý nào khác.
                </li>
              </ul>
            </li>
          </ol>
        ...
        <div style={{ fontSize: "12pt", lineHeight: 1.6 }}>
          ...
          >
            ...
            <li>
              ...
              >
                <li style={{ marginBottom: "6px" }}>
                  Bán, chuyển nhượng, cho mượn, thế chấp, cầm cố tài sản cho bên
                  thứ ba;
                </li>

                <li style={{ marginBottom: "6px" }}>
                  Thay đổi kết cấu, gắn thêm thiết bị trái phép hoặc làm thay
      ...
      <div style={S.section}>
        ...
        <div style={{ fontSize: "12pt", lineHeight: 1.6 }}>
          ...
          >
            {/* 1 */}
            <li style={{ marginBottom: "10px" }}>
              Thời hạn thuê bắt đầu từ ngày {data.NGAY_BAT_DAU} đến khi xảy ra
              một trong các sự kiện sau (tùy điều kiện nào đến trước):
              <ul
                style={{
                  paddingLeft: "40px",
                  marginTop: "6px",
              ...
              >
                <li style={{ marginBottom: "6px" }}>
                  Hai bên thỏa thuận chấm dứt Hợp đồng thuê bằng văn bản/tin
                  nhắn.
                </li>
            ...
            {/* 2 */}
            <li>
              Hết thời hạn thuê, Bên B có trách nhiệm hoàn trả tài sản ngay lập
              tức theo yêu cầu của Bên A.
            </li>
          </ol>
        </div>
      </div>
      ...
      <div style={S.section}>
        ...
        <div style={{ fontSize: "12pt", lineHeight: 1.6 }}>
          <ol
            style={{ paddingLeft: "22px", margin: 0, listStyleType: "decimal" }}
          >
            {/* 1 */}
            ...
            {/* 2 */}
            <li>
              Việc thanh toán không đúng hạn cam kết được xem là vi phạm nghĩa
              vụ Hợp đồng.
            </li>
          </ol>
        </div>
          ...
          >
            ...
            <li style={{ marginBottom: "10px" }}>
              ...
              >
                ...
                <li style={{ marginBottom: "6px" }}>
                  Chịu mọi trách nhiệm pháp lý, dân sự, hình sự, hành chính phát
                  sinh từ việc sử dụng tài sản;
                </li>

                <li>
                  Tự chịu chi phí xăng dầu, bảo dưỡng, sửa chữa trong quá trình
                  sử dụng.
                </li>
              </ul>
            </li>
            ...
            {/* 2 */}
            <li style={{ marginBottom: "10px" }}>
              <strong>Miễn trừ trách nhiệm:</strong> Bên A không chịu trách
              nhiệm đối với mọi thiệt hại về người và tài sản phát sinh trong
              thời gian Bên B sử dụng tài sản.
            </li>
            ...
            <li>
              ...
              >
                <li style={{ marginBottom: "6px" }}>
                  Bẻ khóa, can thiệp, xâm nhập, sửa đổi hệ điều hành hoặc phần
                  mềm của thiết bị;
                </li>

                <li style={{ marginBottom: "6px" }}>
                  Tìm cách vượt qua, vô hiệu hóa hoặc làm sai lệch các cơ chế
                  bảo mật của thiết bị (bao gồm nhưng không giới hạn: iCloud,
                  mật khẩu, Face ID, Touch ID, Activation Lock);
                </li>
              ...
              <p style={{ marginTop: "8px" }}>
                ...
                hư hỏng, thay đổi, lộ lọt hoặc không thể khôi phục dữ liệu trong
                thiết bị hoàn toàn do Bên B tự chịu trách nhiệm.
              </p>
              <p>
                Bên A được miễn trừ toàn bộ trách nhiệm dân sự, bồi thường và
                nghĩa vụ khắc phục liên quan đến dữ liệu trong các trường hợp
                nêu trên.
              </p>
            </li>
          </ol>
      ...
      <div style={S.section}>
        ...
        <div style={{ fontSize: "12pt", lineHeight: 1.6 }}>
          <p style={{ marginBottom: "8px" }}>
            Bên A có quyền đơn phương chấm dứt hợp đồng và{" "}
            <strong>thu hồi tài sản ngay lập tức</strong> nếu:
          </p>
          ...
          >
            <li style={{ marginBottom: "6px" }}>
              Bên B chậm thanh toán tiền thuê (hoặc các nghĩa vụ tài chính liên
              quan) quá <strong>03 ngày</strong>;
            </li>
            ...
            <li>
              Bên B vi phạm nghiêm trọng các điều khoản của Hợp đồng cầm cố hoặc
              Hợp đồng thuê này (như: mang tài sản đi cầm cố nơi khác, mất liên
              lạc…). Bên B cam kết không khiếu nại, không cản trở việc thu hồi
              tài sản trong các trường hợp trên.
            </li>
          </ol>
        </div>
      </div>
      ...
      <div style={S.section}>
        ...
        <div style={{ fontSize: "12pt", lineHeight: 1.6 }}>
          <p style={{ marginBottom: "8px" }}>Hợp đồng chấm dứt khi:</p>
          ...
          >
            <li style={{ marginBottom: "6px" }}>Hết thời hạn thuê;</li>
      ...
      <div style={S.section}>
        ...
        <p style={{ fontSize: "12pt" }}>
          ...
          không đạt được thỏa thuận, tranh chấp sẽ được giải quyết tại{" "}
          <strong>Tòa Án Nhân Dân nơi Bên A đặt trụ sở.</strong>
        </p>
      </div>
      ...
      <div style={S.section}>
        ...
        <div style={{ fontSize: "12pt", lineHeight: 1.6 }}>
          ...
          >
            <li style={{ marginBottom: "8px" }}>
              Hợp đồng này được ký kết độc lập, không phụ thuộc, không phải là
              điều kiện bắt buộc và không ảnh hưởng đến hiệu lực của bất kỳ hợp
              đồng nào khác giữa các bên, dù được ký trước, cùng thời điểm hay
              sau thời điểm ký Hợp đồng này.
            </li>

            <li style={{ marginBottom: "8px" }}>
              Việc ký hoặc không ký Hợp đồng này không làm phát sinh, thay đổi,
              chấm dứt bất kỳ quyền hoặc nghĩa vụ nào của các bên theo các hợp
              đồng khác (nếu có), trừ khi các bên có thỏa thuận khác bằng văn
              bản.
            </li>

            <li>
              Hợp đồng có hiệu lực kể từ ngày ký, được lập thành 02 bản có giá
