    ...
    <div id={id} style={S.container}>
      ...
      <div style={S.section}>
        ...
        >
          ...
          <li style={{ marginBottom: "6px" }}>
            ...
            <span style={{ fontWeight: "bold" }}>{data.BEN_A_DAI_DIEN}</span>
          </li>
      ...
      <div style={S.section}>
        ...
        <p style={{ marginBottom: "8px" }}>
          Bên B đồng ý cầm cố tài sản thuộc sở hữu của mình cho Bên A để đảm bảo
          nghĩa vụ thanh toán khoản vay, cụ thể như sau:
        </p>
        <ul
          style={{
            fontSize: "12pt",
        ...
        <p style={{ fontSize: "12pt", marginBottom: "16px" }}>
          ...
          bị ràng buộc bởi bất kỳ nghĩa vụ nào đối với bên thứ ba tại thời điểm
          ký kết.
        </p>
      </div>
      ...
      <div style={S.section}>
        ...
        >
          ...
          <li style={{ marginBottom: "6px" }}>
            <span style={{ fontWeight: "bold" }}>Thời hạn vay:</span> Tối đa 30
          ...
          <li>
            <span style={{ fontWeight: "bold" }}>Phương thức trả nợ:</span> Gốc
            trả cuối kỳ; Lãi và phí được tính dựa trên thời điểm tất toán thực
            tế theo các mốc thời gian quy định tại Điều 3.
          </li>
        </ol>
      </div>
      ...
      <div style={S.section}>
        ...
        <p style={{ marginBottom: "10px" }}>
          Bên B có quyền tất toán khoản vay trước hạn bất cứ lúc nào. Lãi suất
          được tính theo quy định pháp luật như sau:
        </p>
        <table
          style={{
            ...S.table,
      ...
      <div style={S.section}>
        ...
        >
          <li style={{ marginBottom: "8px" }}>
            ...
            Bên B (bên cầm cố tài sản) được quyền tự do lựa chọn việc có thuê
            lại hoặc không thuê lại tài sản đã cầm cố cho Bên A sau khi ký hợp
            đồng cầm cố này.
          </li>

          <li style={{ marginBottom: "8px" }}>
            <span style={{ fontWeight: "bold" }}>
              Tính độc lập của giao dịch:
            </span>
          ...
          <li style={{ marginBottom: "8px" }}>
            ...
            Trường hợp Bên B không thuê lại tài sản, tài sản cầm cố sẽ được Bên
            A quản lý, lưu giữ và bảo quản tại kho của Bên A theo đúng quy định
            pháp luật và theo thỏa thuận tại Điều 5 hợp đồng này.
          </li>
          ...
          <li style={{ marginBottom: "8px" }}>
            ...
            Trường hợp Bên B có nhu cầu thuê lại tài sản, các bên sẽ ký hợp đồng
            thuê tài sản riêng, trong đó quy định cụ thể về:
            <ul
              style={{
                marginTop: "6px",
                paddingLeft: "40px",
          ...
          <li>
            ...
            Các bên xác nhận rằng việc thuê lại tài sản là hoàn toàn tự nguyện,
            không bị ép buộc. Việc không ký hợp đồng thuê lại không ảnh hưởng
            đến quyền và nghĩa vụ của các bên theo hợp đồng cầm cố này.
          </li>
        </ol>
      </div>
      ...
      <div style={S.section}>
        ...
        <div style={{ fontSize: "12pt", marginBottom: "16px" }}>
          ...
          >
            <li style={{ marginBottom: "6px" }}>
              Bảo quản tài sản cầm cố đúng theo điều kiện thực tế (Trừ trường
              hợp đã bàn giao lại cho Bên B thuê theo Điều 4).
            </li>
            <li style={{ marginBottom: "6px" }}>
      ...
      <div style={S.section}>
        ...
        <div
          style={{ marginBottom: "16px", fontSize: "12pt", lineHeight: 1.6 }}
        >
          <ol
            style={{
              paddingLeft: "40px",
          ...
          >
            ...
            <li style={{ marginBottom: "8px" }}>
              ...
              đến hạn (Mốc 3), Bên A có toàn quyền xử lý tài sản cầm cố để thu
              hồi nợ (bao gồm nhưng không giới hạn: bán, thanh lý, chuyển nhượng
              tài sản).
            </li>
      ...
      <div style={S.section}>
        ...
        >
          ...
          <li style={{ marginBottom: "8px" }}>
            ...
            quan (như không hiểu, không biết, nhầm lẫn…) để từ chối hoặc trì
            hoãn nghĩa vụ đã cam kết.
          </li>
